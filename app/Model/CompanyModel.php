...
class CompanyModel extends Model
{
    ...
    public function isDefault() {
        ...
        return $this->query("
            SELECT 
            c.id as cid, cname, c.type, director, adress, phone_indicatif, isdefault, phone, mobile,ape, siret, mail, website, about, name, zipcode, city,logo,aprm,rm, facebook,instagram,twitter,linkedin,your_signature,
            d.id as did, d.name as dname
            FROM ".$this->model." as c
            LEFT JOIN pl15x_departments as d ON c.department_id = d.id
    ...
    public function find($id, $idParent = false){
        ...
        return $this->query("
            SELECT c.id as cid, cname, c.type, director, adress, phone_indicatif, country, zipcode, rm, rcs, rc_pro, phone, mobile, fax, website, mail, siret, tva, ape, isdefault, department_id, about, city,logo,facebook,instagram,twitter,linkedin,your_signature,
            d.id as did, d.name
            FROM ".$this->model." as c
