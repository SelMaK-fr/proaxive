...
class EquipmentModel extends Model
{
    ...
    public function allWithClientCategoryBrandsOS(){
        ...
        return $this->query("
            SELECT 
            e.id as eid, e.name as ename, inworkshop, content,status,icon,
            c.id as cid, fullname,
            ce.id as ceid, ce.title ce_title,
            b.b_title,
    ...
    public function findWithClientCategoryBrandsOS(int $id){

        return $this->query("
            SELECT 
            e.id as eid, e.name as ename, inworkshop, content,status,icon,serialnumber,numberproduct,e.year as e_year,licence_os,u_username,u_account_mail,u_password,u_domain,
            n_ipaddress,n_gateway,n_masknetwork,n_dns,n_ssid,n_wifi_key,
            c.id as cid, fullname,
            ce.id as ceid, ce.title ce_title,
            b.b_title,
            os_name, os_release, os_architecture
