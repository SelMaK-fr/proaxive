...
if(file_exists(ROOT.'/public/install.lock')){
// Install App
    $router->get('/', "Installer#home");
    $router->post('/', "Installer#home");
    $router->get('/setup/licence', "Installer#licence");
    $router->post('/setup/licence', "Installer#licence");
    $router->get('/setup/database', "Installer#database");
    $router->post('/setup/database', "Installer#database");
    $router->get('/setup/migrate', "Installer#migrate");
    $router->post('/setup/migrate', "Installer#migrate");
    $router->get('/setup/seeding', "Installer#seeding");
    $router->post('/setup/seeding', "Installer#seeding");
    $router->get('/setup/setting', "Installer#setting");
    $router->post('/setup/setting', "Installer#setting");
    $router->get('/setup/finish', "Installer#finish");
    $router->post('/setup/finish', "Installer#finish");
    $router->get('/setup/redirecttologin', "Installer#renameAll");
    $router->post('/setup/redirecttologin', "Installer#renameAll");
} else {
//// LOGIN DASHBAORD ////
...
// API
    $router->get('/api/stats/interventions/:year', "Api#statsForInterventionWithYear")->with('year', '[0-9]+');
    $router->get('/api/stats/customers/:year', "Api#statsForCustomerWithYear")->with('year', '[0-9]+');
//// ADMIN GET AND POST ////
    $router->get('/admin', "Dashboard#AdminHome#index"); // index dashboard
    $router->get('/admin/stats', "Dashboard#AdminHome#statsByYear"); // index dashboard
    $router->post('/admin/stats', "Dashboard#AdminHome#statsByYear"); // index dashboard
    $router->get('/admin/stats/:year', "Dashboard#AdminHome#statsForYear")->with('year', '[0-9]+'); // index dashboard
// Company
...
// Interventions
    ...
    $router->get('/admin/interventions/at-approved', "Dashboard#AdminIntervention#notApproved");
    ...
    $router->post('/admin/intervention/html/:id', "Dashboard#AdminIntervention#showHtml")->with('id', '[0-9]+');
    ...
    $router->get('/admin/s/interventions', "Dashboard#AdminIntervention#search");
...
// Equipments
    ...
    $router->get('/admin/equipment/:id/show', "Dashboard#AdminEquipment#show")->with('id', '[0-9]+');
...
// Client
    ...
    $router->post('/admin/myaccount', "Dashboard#AdminAuser#myaccount");
    $router->get('/admin/myaccount', "Dashboard#AdminAuser#myaccount");
// Setting
...
// Update App
    $router->get('/admin/update', 'Dashboard#AdminProaxiveUpdate#updateDatabase');
    $router->post('/admin/update', 'Dashboard#AdminProaxiveUpdate#updateDatabase');
    $router->get('/update', 'ProaxiveUpdate#home');
    $router->post('/update', 'ProaxiveUpdate#home');
    $router->get('/update/database-update', 'ProaxiveUpdate#updateDatabase');
    $router->post('/update/database-update', 'ProaxiveUpdate#updateDatabase');
}
$router->run();