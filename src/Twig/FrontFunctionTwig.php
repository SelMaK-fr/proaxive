...
class FrontFunctionTwig extends AbstractExtension
{
    public function getFunctions()
    {
        return [
            ...
            new TwigFunction('getischecked', [$this, 'getIsCheckedPdf']),
            new TwigFunction('getisnotchecked', [$this, 'getIsNotCheckedPdf']),
            new TwigFunction('getischeckedwithvalue', [$this, 'getIsCheckedWithValuePdf']),
     ...
     * @return string
     */
    public function getIsCheckedPdf(?string $var): string
    {
        $html = '';
        if ($var == '1'){
            $html = 'checked';
     ...
     * @return string
     */
    public function getIsNotCheckedPdf(?string $var): string
    {
        $html = '';
        if ($var == '0'){
            $html = 'checked';
     ...
     * @return string
     */
    public function getIsCheckedWithValuePdf(?string $var, ?string $value): string
    {
        $html = '';
        if ($var == $value){
            $html = 'checked';
